...
/* Generated from ../O.Common/iseg.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devFribDiagStdPuppetRunning, *pvar_dset_devbiStream,
    ...
    *pvar_dset_devlonginStream, *pvar_dset_asynLiInt32,
    ...
    *pvar_dset_devCasterMBBIState, *pvar_dset_devmbbiStream,
    ...
    *pvar_dset_devCasterSIMsg, *pvar_dset_devFribDiagStdLocalCommit,
...
static const char * const deviceSupportNames[] = {
    ...
    "devTimestampAI", "devAiGeneralTime", "devAiStats", "devAiClusts",
    "devaiStream", "asynAiInt32", "asynAiInt32Average", "asynAiFloat64",
    "asynAiFloat64Average", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devAoStats", "devaoStream", "asynAoInt32",
    "asynAoFloat64", "asynRecordDevice", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "devFribDiagStdPuppetRunning",
    "devbiStream", "asynBiInt32", "asynBiUInt32Digital", "devBoSoft",
    ...
    "devLsiSoft", "devLsiEnviron", "devlsiStream", "devLsoSoft",
    "devLsoSoftCallback", "devLsoStdio", "devlsoStream", "devMbbiSoft",
    "devMbbiSoftRaw", "devMbbiSoftCallback", "devCasterMBBIState",
    ...
    "devCasterSIMsg", "devFribDiagStdLocalCommit", "devstringinStream",
    ...
    "devWaveformStats", "devwaveformStream", "asynWfOctetCmdResponse",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiClusts, pvar_dset_devaiStream, pvar_dset_asynAiInt32,
    ...
    pvar_dset_devAoStats, pvar_dset_devaoStream, pvar_dset_asynAoInt32,
    pvar_dset_asynAoFloat64, pvar_dset_asynRecordDevice,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_devFribDiagStdPuppetRunning, pvar_dset_devbiStream,
    ...
    pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_devboStream, pvar_dset_asynBoInt32,
    ...
    pvar_dset_devLsiEnviron, pvar_dset_devlsiStream, pvar_dset_devLsoSoft,
    pvar_dset_devLsoSoftCallback, pvar_dset_devLsoStdio,
    pvar_dset_devlsoStream, pvar_dset_devMbbiSoft,
    pvar_dset_devMbbiSoftRaw, pvar_dset_devMbbiSoftCallback,
    pvar_dset_devCasterMBBIState, pvar_dset_devmbbiStream,
    ...
    pvar_dset_devStringinEpics, pvar_dset_devCasterSIMsg,
    pvar_dset_devFribDiagStdLocalCommit, pvar_dset_devstringinStream,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_editSseqRegistrar, pvar_func_fribdiagstd_registrar,
    pvar_func_interpRegister, pvar_func_iocshSystemCommand,
...
int iseg_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/fulcher/Desktop/iseg-ioc";
    ...
    pvar_func_fribdiagstd_registrar();
...
/* iseg_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"iseg_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iseg_registerRecordDeviceDriver(*iocshPpdbbase);
}
