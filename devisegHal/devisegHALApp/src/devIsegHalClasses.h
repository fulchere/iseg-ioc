...
class isegHalConnectionHandler {
 public:
   ...
   bool connect( char const* name, char const* host, char const* port );
 ...
 private:
  ...
  ~isegHalConnectionHandler();
  isegHalConnectionHandler( isegHalConnectionHandler const& rother ) = delete; //!< copy constructor, not implemented
  isegHalConnectionHandler& operator=( isegHalConnectionHandler const& rother ) = delete; //!< Copy assignment operator not implemented
